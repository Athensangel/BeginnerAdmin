	...
	<body>
		<div class="admin-main">
			...
			<fieldset class="layui-elem-field">
				...
				<form action="${pageContext.request.contextPath}/UserServletUpdate" method="post">
					...
					<table class="site-table table-hover">
						...
						<tbody>
							<tr>
								...
								<td>
									<%-- <a href="${pageContext.request.contextPath}/userServletUp?toid=${user.toid}" class="layui-btn layui-btn-mini">编辑</a> --%>
